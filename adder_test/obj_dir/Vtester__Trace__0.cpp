...
void Vtester___024root__trace_chg_0_sub_0(Vtester___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vtester___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtester___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vtester___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vtester___024root__trace_chg_0_sub_0(Vtester___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtester___024root__trace_chg_0_sub_0\n"); );
    Vtester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vtester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtester___024root__trace_cleanup\n"); );
    // Init
    Vtester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtester___024root*>(voidSelf);
